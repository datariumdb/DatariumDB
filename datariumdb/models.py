...
from datariumdb.common.crypto import hash_data, PublicKey, PrivateKey
from datariumdb.common.exceptions import (InvalidHash, InvalidSignature,
                                          DoubleSpend, InputDoesNotExist,
                                          TransactionNotInValidBlock,
                                          AssetIdMismatch, AmountError,
                                          SybilError,
                                          DuplicateTransaction)
from datariumdb.common.transaction import Transaction
from datariumdb.common.utils import gen_timestamp, serialize
from datariumdb.common.schema import validate_transaction_schema


class Transaction(Transaction):
    def validate(self, datarium):
        """Validate transaction spend

        Args:
            datarium (Datarium): an instantiated datariumdb.Datarium object.
        ...
        if self.operation == Transaction.TRANSFER:
            ...
            for input_ in self.inputs:
                ...
                if status != datarium.TX_VALID:
                    raise TransactionNotInValidBlock(
                        'input `{}` does not exist in a valid block'.format(
                            input_txid))

                spent = datarium.get_spent(input_txid, input_.fulfills.output)
    ...
    @classmethod
    def from_db(cls, datarium, tx_dict):
        """
        ...
        Args:
            datarium (:class:`~datariumdb.Datarium`): An instance of Datarium
        ...
        if tx_dict['operation'] in [Transaction.CREATE, Transaction.GENESIS]:
            ...
            asset = list(datarium.get_assets([tx_dict['id']]))[0]
            del asset['id']
...
class Block(object):
    ...
    def validate(self, datarium):
        ...
        Args:
            datarium (:class:`~datariumdb.Datarium`): An instantiated Datarium
                object.
        ...
        self._validate_block(datarium)
        self._validate_block_transactions(datarium)

        return self

    def _validate_block(self, datarium):
        ...
        if self.node_pubkey not in datarium.federation:
    ...
    def _validate_block_transactions(self, datarium):
        ...
        for tx in self.transactions:
            ...
            datarium.validate_transaction(tx)
    ...
    def is_signature_valid(self):
        ...
        try:
            ...
            #       https://github.com/datariumdb/cryptoconditions/issues/27
    ...
    @classmethod
    def from_db(cls, datarium, block_dict, from_dict_kwargs=None):
        """
        ...
        assets = datarium.get_assets(asset_ids)
