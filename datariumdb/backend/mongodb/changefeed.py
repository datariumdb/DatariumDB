...
from datariumdb.backend.exceptions import BackendError
...
class MongoDBChangeFeed(ChangeFeed):
    ...
    def run_forever(self):
        ...
        for record in run_changefeed(self.connection, table, last_ts):
            ...
            # See https://github.com/datariumdb/datariumdb/issues/992
...
def get_changefeed(connection, table, operation, *, prefeed=None):
    ...
    Returns:
        An instance of
        :class:`~datariumdb.backend.mongodb.MongoDBChangeFeed`.
    """
