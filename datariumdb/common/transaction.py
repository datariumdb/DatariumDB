...
from datariumdb.common.crypto import PrivateKey, hash_data
from datariumdb.common.exceptions import (KeypairMismatchException,
                                          InvalidHash, InvalidSignature,
                                          AmountError, AssetIdMismatch,
                                          ThresholdTooDeep)
from datariumdb.common.utils import serialize
...
class Input(object):
    ...
    Wraps around a Crypto-condition Fulfillment.
        ...
        Attributes:
            ...
            fulfills (:class:`~datariumdb.common.transaction. TransactionLink`,
    ...
    def __init__(self, fulfillment, owners_before, fulfills=None):
        """Create an instance of an :class:`~.Input`.
            ...
            Args:
                ...
                fulfills (:class:`~datariumdb.common.transaction.
    ...
    def from_dict(cls, data):
        """Transforms a Python dictionary to an Input object.
            ...
            Returns:
                :class:`~datariumdb.common.transaction.Input`
...
class TransactionLink(object):
    ...
    def from_dict(cls, link):
        """Transforms a Python dictionary to a TransactionLink object.
            ...
            Returns:
                :class:`~datariumdb.common.transaction.TransactionLink`
        """
        try:
...
class Output(object):
    ...
    def from_dict(cls, data):
        """Transforms a Python dictionary to an Output object.
            ...
            Returns:
                :class:`~datariumdb.common.transaction.Output`
        """
        try:
...
class Transaction(object):
    """A Transaction is used to create and transfer assets.
        ...
        Attributes:
            ...
            inputs (:obj:`list` of :class:`~datariumdb.common.
                transaction.Input`, optional): Define the assets to
                spend.
            outputs (:obj:`list` of :class:`~datariumdb.common.
    ...
    def create(cls, tx_signers, recipients, metadata=None, asset=None):
        """A simple way to generate a `CREATE` transaction.
            ...
            Note:
                ...
                Additionally, it provides support for the following DatariumDB
                use cases:
            ...
            Returns:
                :class:`~datariumdb.common.transaction.Transaction`
        """
    ...
    def transfer(cls, inputs, recipients, asset_id, metadata=None):
        """A simple way to generate a `TRANSFER` transaction.
            ...
            Args:
                inputs (:obj:`list` of :class:`~datariumdb.common.transaction.
    ...
    def to_inputs(self, indices=None):
        """Converts a Transaction's outputs to spendable inputs.
            ...
            Returns:
                :obj:`list` of :class:`~datariumdb.common.transaction.
                    Input`
        """
    ...
    def add_input(self, input_):
        """Adds an input to a Transaction's list of inputs.
            ...
            Args:
                input_ (:class:`~datariumdb.common.transaction.
    ...
    def add_output(self, output):
        """Adds an output to a Transaction's list of outputs.
            ...
            Args:
                output (:class:`~datariumdb.common.transaction.
    ...
    def get_asset_id(transactions):
        ...
        Args:
            transactions (:obj:`list` of :class:`~datariumdb.common.
