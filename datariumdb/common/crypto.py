...
def generate_key_pair():
    ...
    Returns:
        :class:`~datariumdb.common.crypto.CryptoKeypair`: A
        :obj:`collections.namedtuple` with named fields
        :attr:`~datariumdb.common.crypto.CryptoKeypair.private_key` and
        :attr:`~datariumdb.common.crypto.CryptoKeypair.public_key`.
