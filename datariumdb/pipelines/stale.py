...
class StaleTransactionMonitor:
    ...
    def __init__(self, timeout=5, backlog_reassign_delay=None):
        ...
        Args:
            ...
            backlog_reassign_delay: How stale a transaction should
                ...
                the Datarium default value.
        """
        self.datarium = Datarium(backlog_reassign_delay=backlog_reassign_delay)
    ...
    def check_transactions(self):
        ...
        """
        sleep(self.timeout)
        for tx in self.datarium.get_stale_transactions():
            yield tx
    ...
    def reassign_transactions(self, tx):
        ...
        self.datarium.reassign_transaction(tx)
        return tx
