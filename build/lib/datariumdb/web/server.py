"""This module contains basic functions to instantiate the DatariumDB API.
...
from datariumdb import utils
from datariumdb import Datarium
from datariumdb.web.routes import add_routes
from datariumdb.web.strip_content_type_middleware import StripContentTypeMiddleware
...
def create_app(*, debug=False, threads=1):
    ...
    app.config['datarium_pool'] = utils.pool(Datarium, size=threads)
...
def create_server(settings):
    ...
    settings['logger_class'] = 'datariumdb.log.loggers.HttpServerLogger'
