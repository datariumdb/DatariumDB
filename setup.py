"""
DatariumDB: A Scalable Blockchain Database

For full docs visit https://docs.datariumdb.com
...
# get the version
version = {}
with open('datariumdb/version.py') as fp:
...
setup(
    ...
    description='DatariumDB: A Scalable Blockchain Database',
    long_description=(
        "DatariumDB allows developers and enterprises to deploy blockchain "
        "proof-of-concepts, platforms and applications with a scalable blockchain "
        "database. DatariumDB supports a wide range of industries and use cases "
        ...
        "powerful functionality to automate business processes, DatariumDB looks, "
        "acts and feels like a database but has the core blockchain "
        "characteristics that enterprises want."
        ),
    url='https://github.com/DatariumDB/datariumdb/',
    author='DatariumDB Contributors',
    ...
    entry_points={
        'console_scripts': [
            'datariumdb=datariumdb.commands.datariumdb:main'
        ],
    },
    ...
    package_data={'datariumdb.common.schema': ['*.yaml']},
)
